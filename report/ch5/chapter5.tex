...
For this the text summarization will pre order the senteces by calculating the X  coseno between the original sentence and the \dots %TODO
...
\dots %TODO table with sentence scores
