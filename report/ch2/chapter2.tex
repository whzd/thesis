...
\section{Língua Gestual Portuguesa (LGP)}
...
It's entirely up to the user to chose the structure to use.
...
Trying to achieve a similar goal using a different approach, Noraset Thanapon et al.\cite{noraset2016definition} used Deep Learning, more precisely \gls{RNN} to generate a definition g a definition for a given word and its embedding
The models were trained using a pre-defined database.

Ni Ke et al.\cite{ni2017learning} also chose a Deep Learning approach, using \gls{RNN} to generate a definition of slang words or expressions in twits.
...
Its appearance  was made identical to the human body to help the process of translation.
