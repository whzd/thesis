...
Firstly, by contextualizing it, establishing the problem associated with it and the goals set to be achieved.
...
Humans learn by interaction with others or the environment.
...
One disadvantage of this approach is that not every human has the same previous knowledge, therefore, if not tailored, it will take different people different time to understand.
On the other hand, a major advantage is the encouragement of understanding which benefits retention of knowledge.

Novak wrote in his book\cite{novak2010learning} that meaningful learning has three requirements :
...
\begin{itemize}
    ...
    \item Meaningful material - It is composed by significant concepts and relevant to other knowledge, previously acquired.
...
Humans have learned concepts even if they are not aware of them.
...
The concept of chair is made by those shared characteristics and once one understands that concept, he will be able to identify most chairs as such.
...
To understand a concept like 'Nanotechnology', which there are no signs for, a \gls{LGP} user has to access tools with content made for the Portuguese users.
