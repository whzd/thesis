...
\textbf{Accessibility}: In order to use this application the user need to have a devide with internet connection, preferbly a computer.
...
\textbf{Performance}: Good performance is always a must, especially when ussing a search engine, the users want a fast response, therefore the generation of explanations was optimize to take as little time as possible.
