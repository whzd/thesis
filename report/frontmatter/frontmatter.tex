...
\begin{acknowledgements}
    Firstly, to Instituto Superior de Educação do Porto for all the knowledge it allowed me to get and all the support its teachers provided, with special focus on Dr. Nuno Escudeiro for being my supervisor in this project.
    ...
    Also for following your dreams and walking the path him here finishing.
    Always remember, "May we get what we want, may we get what we need, but never what we deserve".
