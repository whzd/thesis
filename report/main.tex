...
\committeepresident{Dr. Carlos Ramos, Professor, DEI/ISEP} % Name of the president of the evaluation committee, print it elsewhere with \presidentname

\committeemembers{Dr. Nuno Escudeiro, Professor, DEI/ISEP\\Dr. Alberto Simões, Professor, IPCA} % Name of the evaluation committee members (up to four), print it elsewhere with \committee

\keywords{Sign language, Web crawler, Web scrapping, Text summarization, Automatic concept explanation} % Please define up to 6 keywords that better describe your work, print it elsewhere with \keywordnames
