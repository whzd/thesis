...
In this PhD report, the author uses a different approach from the regular word extraction methods.
This approach focus on extracting all the concepts and make the application that will uses them, decide their relevance.
