...
\begin{abstract}
    ...
    With the goal to solve this problem, this solution was created with the hypothesis of being able to utilize machine learning techniques, summarization and automatic translation to generate the explanation of a given word or expression in Lingua Gestual Portuguesa (LGP), that does not exist in its lexicon.
...
To target an even broader audience the project might support other languages which, the previously mentioned avatar, is capable of performing the translation of plain text to the corresponding sign language.
