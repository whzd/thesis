...
There is however some partial solutions, like online dictionaries and sign language interpreters.
...
The main limitation of this solutions is the necessity of previously recorded translations.

\subsection{Sign Language Interpreter}

CTILG \cite{ctilg_2020} is a company that provides professional LGP translation services in workshops, classes, congresses, events and more.

\dots

A more affordable solution is the Serviin \cite{serviin_2020} which is a service that provides a interpreter to work as a middle-man between a deaf person and a targeted service/company.
This solution is available as a mobile app, with a very low cost for the deaf user or through a web app that is free.

The main limitation of this solutions is the need to rely on another person to accomplish a task.
This removes the autonomy of the LGP user.

\subsection{Portuguese Readability Metrics}

Readability metrics are used for...
There are some widly known and used metrics for the English language, such as ...
This metrics predict the grade the user must have to fully understand the content of a given text.
...
The adapted readability metrics are presented in table \cite{table1}.
