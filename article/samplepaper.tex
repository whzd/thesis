...
this functionalities are \dots
1 the explanations displayed in plain text will also be translated to LGP by integrating the GILT avatar with the web application.
2 present a realiable LGP score for each presented expression
