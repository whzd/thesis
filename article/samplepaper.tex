...
Having the need for a metric that targeted the LGP user and was able to be used for sorting generated explanations, one of this project contributions is a formula that is able to calculate the readability of a sign in LGP.
But the main contribution of this project is the ability to present in LGP a generated explanation of a given word or expression.

In regards to the evaluations to be made, the reliability of the generated explanation as well as the precision of the developed formula will be evaluated by surveying the target audience.
...
This article presents a general view of the project that is still in development, thus more functionalities are still going to be implemented in order to better fulfill the need of its target audience.
