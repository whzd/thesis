...
According to the Portuguese Deaf Association there are around 150000 people with some type of earing impairment and around 30000 of those that use the Portuguese Sign Language (PSL) (\cite{Reference7}).
...
The other parts used in Portuguese Language, like the propositions and the arthicles, are omitted when converted to PSL (\cite{Reference8}), (\cite{Reference9}).

Some gramatical caracteristics of the Portuguese Sign Language are (\cite{Reference8}):
...
This techniques are the following: Rule-based, Statictical, Hybrids (both rule-based and statistical) and Conditional Random Fields (\cite{Reference5}).

A rule-based approach was used by Rosa Del Gaudio and António Branco (\citeyear{Reference4}).
...
A statistical approach was used by Ventura (\citeyear{Reference6}). 
