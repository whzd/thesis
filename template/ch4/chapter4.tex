...
\label{chap:Chapter4} % For referencing the chapter elsewhere, use \ref{chap:Chapter2} 
...
\begin{figure}[b]
\centering
\includegraphics[scale=0.5]{ch4/assets/electron}
\caption[An Electron]{An electron (artist's impression).}
\label{fig:electron}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ch4/assets/comic}
